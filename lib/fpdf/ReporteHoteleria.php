...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(100, 10, utf8_decode("REPORTE DE HOTELES REGISTRADOS"), 0, 1, 'C', 0);
      $this->Ln(7);
      ...
      $this->Cell(30, 10, utf8_decode('LOGOTIPO'), 1, 0, 'C', 1);
      $this->Cell(50, 10, utf8_decode('CLAVE DE HOTEL'), 1, 0, 'C', 1);
      $this->Cell(40, 10, utf8_decode('NOMBRE DEL HOTEL'), 1, 0, 'C', 1);
      $this->Cell(40, 10, utf8_decode('PROPIETARIO'), 1, 0, 'C', 1);
      $this->Cell(85, 10, utf8_decode('DOMICILIO'), 1, 0, 'C', 1);
...
$consulta_reporte_hotel = $conexion->query(" SELECT * FROM HOTELERIA ");

while ($datos_reporte = $consulta_reporte_hotel->fetch_object()) {   
   /* TABLA */
   $pdf->Cell(30,10, $pdf->Image("../".$datos_reporte->logo, $pdf->GetX(), $pdf->GetY(),10),1);
   $pdf->Cell(50, 10, utf8_decode("$datos_reporte->claveHotel"), 1, 0, 'C', 0);
   $pdf->Cell(40, 10, utf8_decode("$datos_reporte->nombreHotel"), 1, 0, 'C', 0);
   $pdf->Cell(40, 10, utf8_decode("$datos_reporte->propietario"), 1, 0, 'C', 0);
   $pdf->Cell(85, 10, utf8_decode("$datos_reporte->domicilio"), 1, 0, 'C', 0);
   $pdf->Cell(40, 10, utf8_decode("$datos_reporte->estatus"), 1, 1, 'C', 0);
}
$date = date("d M Y");
