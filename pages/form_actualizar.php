...
<html lang="es">
  ...
  <?php
    ...
    ?>
      <div class="board">
        <div class="form">
          <form action="/highHotel/php/actualizar_contrasena.php" method="post" enctype="multipart/form-data">
              <h2>Actualiza tu contraseña</h2>

              <label for="claveEmpleado">Clave del Empleado</label>
              <input type="text" id="claveEmpleado" name="claveEmpleado" value="<?php echo $_SESSION['claveE'] ?>" readonly >

              <label for="contrasena">Nueva contraseña de usuario</label>
